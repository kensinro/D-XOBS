# -*- coding: utf-8 -*-
r"""
D-PHY TCGA-BRCA ER-status endpoint ESR1-excluded sensitivity test V2
==========================================
...
Outputs
-------
D:/AIDO-Temp/D_PHY_TCGA_BRCA_ER_Status_ESR1_Excluded_V2_<timestamp>/
...
# Direct-marker sensitivity analysis. ESR1 is removed from every BP gene set before scoring.
EXCLUDE_ESR1_FROM_BP_SCORING = True
...
def main():
    ...
    run_root = BASE_OUTPUT_DIR / f"D_PHY_TCGA_BRCA_ER_Status_ESR1_Excluded_V2_{time.strftime('%Y%m%d_%H%M%S')}"
    ensure_dir(run_root)

    log("=" * 80)
    log("D-PHY TCGA-BRCA ER-status endpoint ESR1-excluded sensitivity test V2")
